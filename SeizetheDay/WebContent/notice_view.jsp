...
<!-- ������ũ:https://peterkimlab.github.io/jsp/JSP-%EA%B2%8C%EC%8B%9C%ED%8C%90-%EC%9B%B9-%EC%82%AC%EC%9D%B4%ED%8A%B8-%EB%A7%8C%EB%93%A4%EA%B8%B0/ -->
<!--notice����������  ����ȭ�� ���� css ��ũ�� trend.css���. �򰥸� ���� -->
						...
						<%
							...
							for (int i = 0; i < vlist.size(); i++) {
								...
								if (noticeBean.getNOTICE_SEQ() == notice_seq) {
									...
									//notice_writer_=noticeBean.getUSER_SEQ();//�߰�
									notice_writer=noticeMgr.getUSER_NAME(noticeBean.getUSER_SEQ());//
									System.out.println("sql�� ���� notice_writer: "+notice_writer);
								}
							}
						%>
						<tr>
