...
<body>
	...
	<div class="trend">
		<div class="trend-title">Notice</div>
		<div class="container">
			<div class="row">
				<table class="table table-striped"
					style="text-align: center; border: 1px solid #333344; width: 100%;">
					<thead>
						<tr>
							<th colspan="3"
				...
				<div class="head1">
					<div class="user-section">
						<a href="notice.jsp" class="user-button"
							style="border: 2px solid #333344;">목록</a>
					</div>
				</div>
			</div>
		</div>
