	...
	<div class = "myPage">
		...
		<div class = "myBtnGroup">
			...
			<tr>
				...
				<td><div class = "btn3"><a href="inquiry.jsp"><img src="mypage_image/askWith1.png"><img src="mypage_image/askWith2.png"></a></div></td>
			</tr>
			</table>
		</div>
	
		<div class = "deleteInfo"><a href="deleteUser.jsp">회원탈퇴</a></div>
